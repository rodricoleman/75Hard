    ...
    <Screen>
      ...
      <Card style={{ marginTop: spacing.lg }}>
        ...
        <View style={styles.switchRow}>
          <View style={{ flex: 1 }}>
            <Text style={styles.swTitle}>Som ao cumprir hábito</Text>
            <Text style={styles.swDesc}>Toca um beep + haptic. Toggle off pra modo silencioso.</Text>
          </View>
          <Switch
      ...
      <Card style={{ marginTop: spacing.lg }}>
        ...
        />
        <Button label="Ativar / atualizar lembrete" onPress={enableNotifs} variant="subtle" />
        <Text style={styles.hint}>
          No iOS/Android você recebe um push local. No web, só funciona com o app aberto na aba.
        </Text>
      </Card>
...
const styles = StyleSheet.create({
  ...
  email: { color: colors.textMuted, fontSize: font.size.xs, marginTop: spacing.md },
  hint: { color: colors.textDim, fontSize: font.size.xs, marginTop: spacing.sm },
  switchRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.md,
  ...
  swTitle: { color: colors.text, fontSize: font.size.md, fontWeight: '700' },
  swDesc: { color: colors.textMuted, fontSize: font.size.xs, marginTop: 2 },
});
